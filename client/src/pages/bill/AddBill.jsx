    ...
    <>
      <div className="m-5 lg:mx-[40rem]">
        ...
        <div className="my-8 mx-2 display-bill flex justify-center">
          <div className="max-w-[30rem] w-[28rem]  py-4 px-4 bg-neutral-200 rounded-lg flex flex-col justify-center">
            <input
              type="text"
            ...
            <span className="text-center">{new Date().toLocaleString()}</span>
            ...
            <div className="grid my-4">
              ...
              <div
                className="grid grid-flow-col grid-cols-3 gap-0 bg-inherit [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
